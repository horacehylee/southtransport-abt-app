...
export function registerScreens(store, provider) {
    ...
    Navigation.registerComponent("abt.settings", () => screenWrapper(Settings), store, provider)
    Navigation.registerComponent("abt.about", () => screenWrapper(About), store, provider)
}
